...
/* Generated from ../O.Common/PowerSupply1.dbd */
...
int PowerSupply1_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/epics/Downloads/FukingShit/PowerSupply";
...
/* PowerSupply1_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: PowerSupply1_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(PowerSupply1_registerRecordDeviceDriver(*iocshPpdbbase));
}
